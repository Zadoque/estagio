...
export default function QrCodesPage() {
  ...
  useEffect(() => {
    const generate = async () => {
      try {
        const result = await listInterns(null);
